...
public enum CheckersScenario {
    LONELY_PIECE {
        public List<Piece> getScenario() {
            ...
            scenario.add(new Piece(PieceColor.LIGHT, Position2.getPosition(18)));
            return scenario;
        }
    },
    LONELY_KING {
        public List<Piece> getScenario() {
            List<Piece> scenario = new ArrayList<Piece>();
            scenario.add(new Piece(PieceColor.LIGHT, Position2.getPosition(18)).setCrowned(true));
            return scenario;
        }
    },
    KING_ONE_OPTION {
        public List<Piece> getScenario() {
            List<Piece> scenario = new ArrayList<Piece>();
            scenario.add(new Piece(PieceColor.LIGHT, Position2.getPosition(18)).setCrowned(true));
            scenario.add(new Piece(PieceColor.DARK, Position2.getPosition(14)));
            return scenario;
        }
    },
    KING_BACKWARDS_DOUBLE_JUMP {
        public List<Piece> getScenario() {
            List<Piece> scenario = new ArrayList<Piece>();
            scenario.add(new Piece(PieceColor.LIGHT, Position2.getPosition(2)).setCrowned(true));
            scenario.add(new Piece(PieceColor.DARK, Position2.getPosition(7)));
            scenario.add(new Piece(PieceColor.DARK, Position2.getPosition(15)));
            return scenario;
        }
    },
    ...
    DOUBLE_JUMP_ONE_OPTION {
        public List<Piece> getScenario() {
            ...
            scenario.add(new Piece(PieceColor.LIGHT, Position2.getPosition(18)));
            scenario.add(new Piece(PieceColor.DARK, Position2.getPosition(14)));
            scenario.add(new Piece(PieceColor.DARK, Position2.getPosition(6)));
            return scenario;
        }
    },
    DOUBLE_JUMP_ONE_OPTION_TWO_OPTIONS {
        public List<Piece> getScenario() {
            ...
            scenario.add(new Piece(PieceColor.DARK, Position2.getPosition(15)));
            scenario.add(new Piece(PieceColor.DARK, Position2.getPosition(7)));
            scenario.add(new Piece(PieceColor.DARK, Position2.getPosition(8)));
    ...
    TWO_PIECES_ONE_JUMP_ONE_ADJACENT { // for easy copy and pasting to create new scenarios
        public List<Piece> getScenario() {
            ...
            scenario.add(new Piece(PieceColor.LIGHT, Position2.getPosition(7)));
            return scenario;
        }
    },
