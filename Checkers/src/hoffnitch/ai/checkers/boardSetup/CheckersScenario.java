...
public enum CheckersScenario {
    LONELY_PIECE {
        public List<Piece> getScenario() {
            ...
            scenario.add(new Piece(PieceColor.LIGHT, new Position(18)));
            return scenario;
        }
    },
    LONELY_KING {
    ...
    DOUBLE_JUMP_ONE_OPTION {
        public List<Piece> getScenario() {
            ...
            scenario.add(new Piece(PieceColor.LIGHT, new Position(18)));
            scenario.add(new Piece(PieceColor.DARK, new Position(14)));
            scenario.add(new Piece(PieceColor.DARK, new Position(6)));
            return scenario;
        }
    },
    DOUBLE_JUMP_ONE_OPTION_TWO_OPTIONS {
        public List<Piece> getScenario() {
            ...
            scenario.add(new Piece(PieceColor.DARK, new Position(15)));
            scenario.add(new Piece(PieceColor.DARK, new Position(7)));
            scenario.add(new Piece(PieceColor.DARK, new Position(8)));
    ...
    TWO_PIECES_ONE_JUMP_ONE_ADJACENT { // for easy copy and pasting to create new scenarios
        public List<Piece> getScenario() {
            ...
            scenario.add(new Piece(PieceColor.LIGHT, new Position(7)));
            return scenario;
        }
    },
